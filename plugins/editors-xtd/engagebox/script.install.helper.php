...
class PlgEditorsxtdEngageboxInstallerScriptHelper
{
	public $name = '';
	public $alias = '';
	public $extname = '';
	...
	public function loadFramework() 
	{
        ...
        $file = JPATH_PLUGINS . '/system/nrframework/helpers/functions.php';

 		if (class_exists("NRFrameworkFunctions") || !JFile::exists($file))
        {
            return;
        }
	...
	public function pluginOrderAfter($lowerPluginOrder)
    {
        ...
        $query
            ...
            ->where($db->quoteName('element') . ' IN ("'.implode("\",\"",$lowerPluginOrder).'")')
            ->order('ordering desc');
